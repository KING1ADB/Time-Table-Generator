          ...
          <div className="mt-8 pt-6 border-t border-slate-800 print:border-black flex items-center justify-between text-xs text-slate-400 print:text-black">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <img src="/logo.png" alt="CamTime Logo" className="w-5 h-5 object-contain rounded" />
                <span className="font-bold text-xs text-slate-200 print:text-black">CamTime</span>
              </div>
              <p className="font-mono text-[10px]">
                Generated by CamTime Timetable Engine • Powered by <strong>Neurivex Group</strong> • {new Date().toLocaleDateString()}
              </p>
            </div>
